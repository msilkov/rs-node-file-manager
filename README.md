...
This project involves building a **File Manager** using Node.js APIs, accessible via the command line. The File Manager should allow users to perform various file and directory operations, along with getting system information, calculating hashes, and performing file compression/decompression.

## Features

The File Manager will be able to:
- Operate via a Command Line Interface (CLI).
- Perform basic file operations (copy, move, delete, rename, etc.).
- Leverage the Streams API for reading, writing, and copying files.
- Provide information about the host operating system.
